...
public class CartList {
	...
	public void searchProduct(String bName,String runMode) throws InterruptedException
	{
		...
		else
		{
		 ...
		 genericPage page=new CartListPage() 
				 		 .goToCartList();
		 
		 if(page.equals(null))
		 {
			 page.validator(true).fail("Cart not displayed", "Error on page");
		 }else if(page instanceof CartListPage)
		 {
			 
			 page.validator(false).logInfoInReports("Shopping Cart displayed");
